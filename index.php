...
SESSION_START();
//Song Titles
$song_lyrics1 = "Like A Rose";
$song_lyrics2 = "Dating Tayo";
$song_lyrics3 = "Ikaw Lamang";
$song_lyrics4 = "Pasensya Ka Na";
$song_lyrics5 = "Buwan";
...
if($_REQUEST['song_title']==$song_lyrics1) {
	header("Location: ".$url_add."?likearose");
} 
else if ($_REQUEST['song_title']==$song_lyrics2) {
	header ("Location: ".$url_add."?datingtayo");
}
else if ($_REQUEST['song_title']==$song_lyrics3) {
	header("Location: ".$url_add."?ikawlamang");
}
else if ($_REQUEST['song_title']==$song_lyrics4) {
	header("Location: ".$url_add."?pasensyakana");
}
else if ($_REQUEST['song_title']==$song_lyrics5) {
	header("Location: ".$url_add."?buwan");
}
   //session variable
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section id="songs">
            <div class="container px-4 ">
                <div class="row gx-4 justify-content-center">
                    ...
                    <?php
                    if(isset($_REQUEST['likearose'])===true){
                    	echo "Redirecting....";
                    	header("Refresh: 2; url=song1.php");
                    }else 
                    if(isset($_REQUEST['datingtayo'])===true){
                    	echo "Redirecting....";
                    	header("Refresh: 2; url=song2.php");
                    }else 
                    if(isset($_REQUEST['ikawlamang'])===true){
                    	echo "Redirecting....";
                    	header("Refresh: 2; url=song3.php");
                    }else 
                    if(isset($_REQUEST['pasensyakana'])===true){
                    	echo "Redirecting....";
                    	header("Refresh: 2; url=song4.php");
                    }else 
                    if(isset($_REQUEST['buwan'])===true){
                    	echo "Redirecting....";
                    	header("Refresh: 2; url=song5.php");
                    }
                    ...
                    name="song_title"> </div>
                    <button type="submit" class="btn btn-primary rounded submit p-3 px5" name="search_button"> Search </button>
                          </div>
                         </div
                        </form>
        ...
        <footer class="py-3 bg-danger">
            <div class="container px-4"><p class="m-0 text-center text-white">Copyright &copy; 2022. Janica R. Garay</p></div>
        </footer>
        <!-- Bootstrap core JS-->
